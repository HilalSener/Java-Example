...
public class Movies extends javax.swing.JFrame {
    ...
    public static void getMovies() throws Exception
    {
        ...
        try {
            ...
            while(sonuc.next())
            {
                ...
                String filmAd = sonuc.getString("filmAd");
                String tur = sonuc.getString("tur");
                int sure = sonuc.getInt("sure");
                int imdb = sonuc.getInt("imdb");
                Object[] resultList = { id, filmAd, tur, sure, imdb };
                
                //System.out.println(Arrays.toString(resultList));
                dtm.addRow(resultList);
            }
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        AddNewMovie addMovie = new AddNewMovie();
    ...
    private void btnDelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDelActionPerformed
        try 
        {
            ...
            if (ndx == -1)
            {
                JOptionPane.showMessageDialog(this,"Kayıt Seçmelisiniz","Hata", JOptionPane.ERROR_MESSAGE);
                return;
            }
